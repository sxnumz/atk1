        ...
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"\x1b[30;1m•[{now()}]•\x1b[31;1m[\x1b[31;1mbanned_user\x1b[31;1m][\x1b[37;1m•{member.name}\x1b[37;1m")
    ...
    try:
        ...
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"\x1b[30;1m•[{now()}]•\x1b[31;1m[\x1b[31;1mdeleted_channel\x1b[31;1m")
    ...
    try:
        ...
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"\x1b[30;1m•[{now()}]•\x1b[31;1m[\x1b[31;1mdeleted_role\x1b[31;1m\x1b[37;1m")
                    break
                else:
    ...
    try:
        ...
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"\x1b[30;1m•[{now()}]•\x1b[37;1m[\x1b[37;1mcreated_role\x1b[37;1m")
                    break
                else:
    ...
    try:
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"\x1b[30;1m•[{now()}]•\x1b[37;1m[\x1b[37;1mcreate_channel\x1b[37;1m")
...
async def on_ready():
    ...
    os.system(f"title RHAISZ Socute")
    print(f"\x1b[37;1m {client.user.name}\x1b[37;1m\n")
    print(banner)
    print(f"\x1b[30;1m")
    print(f"\x1b[30;1m                  \x1b[37;1mNuker RHAISZ_ Server RHAISZ_SHOP RT\x1b[37;1m")
    print(f"\x1b[30;1m                        \x1b[37;1mdelete Server discord\x1b[37;1m")       
    print(f"\x1b[30;1m            \x1b[37;1mSupport Server  https://discord.gg/RHAISZ\x1b[37;1m")
    print(f"\x1b[30;1m")
    print(f"\x1b[30;1m     \x1b[31;1m[1] \x1b[37;1m{prefix}spammer         \x1b[31;1m[>] \x1b[37;1mIDSERVER AMOUNT . NAME\x1b[37;1m")
    print(f"\x1b[30;1m     \x1b[31;1m[2] \x1b[37;1m{prefix}Banall          \x1b[31;1m[>] \x1b[37;1mIDSERVER\x1b[37;1m")
    print(f"\x1b[30;1m     \x1b[31;1m[3] \x1b[37;1m{prefix}deletechannels  \x1b[31;1m[>] \x1b[37;1mIDSERVER = 0\x1b[37;1m")
    print(f"\x1b[30;1m     \x1b[31;1m[4] \x1b[37;1m{prefix}createchannel   \x1b[31;1m[>] \x1b[37;1mIDSERVER AMOUNT CHANNELNAME\x1b[37;1m")
    print(f"\x1b[30;1m     \x1b[31;1m[5] \x1b[37;1m{prefix}scrape          \x1b[31;1m[>] \x1b[37;1mIDSERVER\x1b[37;1m")
    print(f"\x1b[30;1m     \x1b[31;1m[6] \x1b[37;1m{prefix}deleteroles     \x1b[31;1m[>] \x1b[37;1mIDSERVER\x1b[37;1m")
    print(f"\x1b[30;1m     \x1b[31;1m[7] \x1b[37;1m{prefix}createrole      \x1b[31;1m[>] \x1b[37;1mIDSERVER AMOUNT ROLENAME\x1b[37;1m")
    print(f"\x1b[30;1m     \x1b[31;1m[8] \x1b[37;1m{prefix}clear\x1b[37;1m")
    print(f"\x1b[30;1m")
    print(f"\x1b[30;1m\x1b[37;1mprint = RHAISZ_ ON TOP ATTACK SERVER\x1b[37;1m")
...
async def spammer(ctx,guildID="help",channelAmount="",roleAmount="",channelName="",roleName=""):
    await ctx.message.delete()
    time.sleep(0.1)
    if guildID.lower() == "help":
        embed = discord.Embed(title="spammer help",color=0x9d00ff)
        embed.add_field(name="Usage",value=f"**{prefix}**spammer (**GUILD ID**) (**CHANNEL AMOUNT**) (**ROLE AMOUNT**) (**CHANNEL NAME**) (**ROLE NAME**)",inline=False)
        embed.add_field(name="Guild id",value="You can get guild id by enabling developer then right click the server name in the top left and click `Copy ID`",inline=False)
